    ...
    if all_unique_tickers:
        ...
        if not holdings.empty and held_tickers:
            ...
            if sector_split.empty:
                ...
                fig_sec, ax_sec = plt.subplots(figsize=(7, 7))
                sector_split.plot.pie(
                    ax=ax_sec,
                    autopct=_make_autopct_with_counts(sector_counts),
                    startangle=90,
                    colors=plt.cm.tab20.colors[:len(sector_split)],
                    textprops={"fontsize": 8.5},
                    pctdistance=0.75,
                    labeldistance=1.08,
                )
                ...
                left_col2, center_col2, right_col2 = st.columns([1, 3, 1])
                with center_col2:
