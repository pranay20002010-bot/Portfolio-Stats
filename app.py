    ...
    if all_unique_tickers:
        ...
        if not holdings.empty and held_tickers:
            ...
            if sector_split.empty:
                ...
                # Keep the original pie chart. Only improve readability:
                # sector names stay in a legend, percentages stay on slices,
                # and tiny slices avoid overlapping text.
                fig_sec, ax_sec = plt.subplots(figsize=(8.5, 6))
                ...
                legend_labels = [
                    ...
                    for sector, weight in sector_split.items()
                ]
