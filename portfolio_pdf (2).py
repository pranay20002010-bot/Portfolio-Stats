    ...
    *,
    ...
    if stats_row is not None:
        rows = [
            ...
            ["Beta (Nifty 500)",      _safe_fmt_float(stats_row.get("Beta (Nifty 500)"))],
            ["Jensen Alpha",          _safe_fmt_pct(stats_row.get("Jensen Alpha"))],
            ["Treynor",               _safe_fmt_float(stats_row.get("Treynor"))],
            ["CVaR 99% (Daily)",      _safe_fmt_pct(stats_row.get("CVaR 99% (Daily)"))],
            ["Max Drawdown",          _safe_fmt_pct(stats_row.get("Max Drawdown"))],
        ]
